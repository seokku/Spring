...
//    alert("modal 삭제");
   ...
   // 전역 변수 선언 - $(function(){~~}); - 33번줄 안에 선언된 함수에서는 공통으로 사용 가능
   var no = ${vo.no};
...
// 			alert(str);
  	 ...
  	 // 댓글 등록 버튼 이벤트 처리 : 댓글의 모달 창 정보 조정과 보이기---------------------------------
...
//   		alert("댓글등록");
		...
		// reply > Form input 데이터 지우기 : input 중에서 id="replyNo"는 제외시킨다. not("#replyNo")
...
//   		alert("댓글 수정");
	 ...
	 // html tag안에 ㅅ고성으로 data-rno="2" 값을 넣어 둔것은 obj.date("rno")로 찾아서 쓴다.
	 var rno = li.data("rno");
...
//   					alert("result: " + result + "\nstatus: " + status);
  	...
  	// $(원래 있었던 객체 선택).on(이벤트, 새로만들어진 태그, 실행함수) -> 이벤트의 전달
					...
					<form action="delete.do" method="post" id="modal_form">
						...
						<div class="form-group">
							<label>비밀번호 : </label> <input name="pw" type="password"
								class="form-control" id="pw" pattern="[^가-힣ㄱ-ㅎ]{4,20}"
		...
		<div id="replyModal" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">×</button>
						<h4 class="modal-title"><i class="fa fa-comments fa-fw"></i>
					...
					<div class="modal-body">
						<form>
							<div class="form-group" id="replyRnoDiv">
								<label for="replyRno">댓글번호:</label> <input name="rno"
									type="text" class="form-control" id="replyRno"
									readonly="readonly">
							</div>

							<div class="form-group" id="replyNoDiv">
								<label for="replyNo">게시판 번호:</label> <input name="no"
									type="text" class="form-control" id="replyNo"
									readonly="readonly" value="${vo.no }">
							</div>

							<div class="form-group" id="replyContentDiv">
								<label for="replyContent" id="replyContentDiv">내용:</label>
								<textarea name="content" class="form-control" rows="5" 
									id="replyContent" required="required"></textarea>
							</div>

							<div class="form-group" id="replyWriterDiv">
								<label for="replyWriter">작성자:</label> <input name="writer"
							...
							<div class="form-group" id="replyPwDiv">
								<label for="replyPw">비밀번호:</label> <input name="pw" type="text"
									class="form-control" id="replyPw" required="required"
									pattern=".{4,20}">
							</div>
						</form>
					</div>
